...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field caregivers on 'Goal'
        m2m_table_name = db.shorten_name(u'gk_goal_caregivers')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('goal', models.ForeignKey(orm[u'gk.goal'], null=False)),
            ('caregiver', models.ForeignKey(orm[u'gk.caregiver'], null=False))
        ))
        db.create_unique(m2m_table_name, ['goal_id', 'caregiver_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field caregivers on 'Goal'
        db.delete_table(db.shorten_name(u'gk_goal_caregivers'))
