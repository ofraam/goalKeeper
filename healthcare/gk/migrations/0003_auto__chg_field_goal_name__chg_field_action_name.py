...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Goal.name'
        db.alter_column(u'gk_goal', 'name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Action.name'
        db.alter_column(u'gk_action', 'name', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Goal.name'
        db.alter_column(u'gk_goal', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Action.name'
        db.alter_column(u'gk_action', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
